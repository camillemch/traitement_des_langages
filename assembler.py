...
# An indexed address can be an int value or a register and an int value between square brackets
...
opcodes = {
	...
	'inc' : 10, # increment register
	'dec' : 11, # decrement register
}
...
# Generate opcode for inc and dec instructions
def generateINCDEC(instr):
	global pc
